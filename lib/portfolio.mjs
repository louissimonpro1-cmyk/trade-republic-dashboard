...
export function buildIntradaySeries(ledger, market) {
  ...
  // anchor the curve at 0%: the reference (previous close) becomes the first point,
  // so the opening gap shows as the first move instead of an unexplained offset
  if (points.length) points.unshift({ t: grid[0] * 1000 - 300000, pct: 0, value: baseline });
