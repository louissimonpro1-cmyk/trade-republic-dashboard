...
import { resolveIsin, dailyHistory, intradayHistory, getFx } from "./yahoo.mjs";
...
export function makePricer(asset, market) {
  ...
  return { currency, hasMarket, source, liveEur, valLiveEur, prevCloseEur, eurAt, adjEurAt, intraEurAt, entry };
}
